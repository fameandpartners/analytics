...
WHERE completed_at IS NOT NULL
	AND total > 0
	AND completed_at BETWEEN '2016-11-22' AND '2016-12-31'

-- SELECT number, completed_at FROM spree_orders WHERE completed_at IS NOT NULL AND total > 0 AND completed_at BETWEEN '2016-11-22' AND '2016-12-31'
...
-- SELECT number, completed_at FROM spree_orders WHERE completed_at IS NOT NULL AND total > 0 AND completed_at BETWEEN '2017-01-01' AND '2017-03-31' AND state != 'canceled' AND number NOT LIKE 'E%'
